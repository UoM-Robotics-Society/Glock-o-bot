...
const int Tune1Length = 184;
const int Tune1NoteMax = 1;
const int Tune1Tempo = 95;
const int Tune1BeatDenom = 4;

  // Harry Potter
const unsigned int Tune1[Tune1NoteMax][Tune1Length] PROGMEM = {{83,0,88,0,0,91,90,0,88,0,0,0,95,0,93,0,0,0,0,0,90,0,0,0,0,0,88,0,0,91,90,0,86,0,0,0,89,0,83,0,0,0,0,0,0,0,0,0,83,0,88,0,0,91,90,0,88,0,0,0,95,0,98,0,0,0,97,0,96,0,0,0,92,0,96,0,0,95,94,0,90,0,0,0,91,0,88,0,0,0,0,0,0,0,0,0,91,0,95,0,0,0,91,0,95,0,0,0,91,0,96,0,0,0,95,0,94,0,0,0,90,0,91,0,0,95,94,0,82,0,0,0,83,0,95,0,0,0,0,0,0,0,0,0,91,0,95,0,0,0,91,0,95,0,0,0,91,0,98,0,0,0,97,0,96,0,0,0,92,0,96,0,0,95,94,0,90,0,0,0,91,0,88}};
