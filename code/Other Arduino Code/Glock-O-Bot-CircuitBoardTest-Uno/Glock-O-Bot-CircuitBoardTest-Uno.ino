...
#define Tune1_Length 5 
const int Part1_Bars = 4;


#define Note_Max 1 // Max number of notes struck per beat = 4
#define Tempo 140 // Beats per minute

//const long Beat_Time = 53571; // 1/8th beat time in uSec( 140bpm )
const long Beat_Time = 1000000; // 1/4th beat time in uSec( 95bpm )


const int start_delay = 0;


const unsigned char Tune1[Note_Max][Tune1_Length] PROGMEM = {{79,81,83,84,86}};
...
const int Graphene_Sen_P = 5; // singnal from graphine conductor, read for status low indicates star
