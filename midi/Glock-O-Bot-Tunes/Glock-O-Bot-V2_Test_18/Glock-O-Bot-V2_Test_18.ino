...
#define Tune_Length 35 // Actual tune length = 288
#define Note_Max 1 // Max nuber of notes struck per beat
#define Tempo 144 // Beats per minute

const long Beat_Time = 2500000; // Half Beat time in uSec 208333

// Enter the tune here (79-108) A-81,B-83,C-84,D-86,E-88,F-89,G-91,A-93,B-95
const unsigned char Tune[Tune_Length][Note_Max] = {79,81,83,84,86,88,89,91,93,95,96,98,100,101,103,105,107,108,107,105,103,101,100,98,96,95,93,91,89,88,86,84,83,81,79}; 
  
  
  //                                                  84,0,89,0,89,0,89,0,91,0,93,91,93,94,96,0,93,0,94,0,93,89,91,0,91,0,89,0,0,0,0,84,0,89,0,89,0,89,0,91,0,93,91,93,94,96,0,93,0,94,0,93,89,91,0,91,0,89,0,0,
