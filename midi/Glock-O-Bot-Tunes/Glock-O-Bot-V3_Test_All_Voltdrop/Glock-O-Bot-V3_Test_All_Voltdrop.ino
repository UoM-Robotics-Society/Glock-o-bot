...
#define Tune_Length 1 // Actual tune length = 288
...
const unsigned char Tune[Tune_Length][Note_Max] = { 98,100,101,103 };
...
void setup() {
  ...
  SPI.begin();
  SPI.beginTransaction(SPISettings(1000000, MSBFIRST, SPI_MODE0)); // 100kHz Shift Clock
  Clear_SR_DataArray();
