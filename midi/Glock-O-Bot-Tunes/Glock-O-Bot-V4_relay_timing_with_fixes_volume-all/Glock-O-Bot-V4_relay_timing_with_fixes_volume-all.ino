...
#define Tune_Length 54 // Actual tune length = 288
#define Note_Max 1 // Max number of notes struck per beat
#define Tempo 200 // Beats per minute

const long Beat_Time = 1000000; // Note time in uSec
...
const int Solenoid_Off_Time = 800; // Pulse width in uSec Fixed
...
void loop() 
  ...
  {
    Solenoid_On_Time_2 = 1000 + (vol*200);
